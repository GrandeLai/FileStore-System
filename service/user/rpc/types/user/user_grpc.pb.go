...
func (c *userClient) GetVolumeByUserId(ctx context.Context, in *VolumeDetailReq, opts ...grpc.CallOption) (*VolumeDetailResp, error) {
	out := new(VolumeDetailResp)
	err := c.cc.Invoke(ctx, "/user.user/GetVolumeByUserId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetVolumeByUserId(context.Context, *VolumeDetailReq) (*VolumeDetailResp, error)
...
func (UnimplementedUserServer) GetVolumeByUserId(context.Context, *VolumeDetailReq) (*VolumeDetailResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVolumeByUserId not implemented")
}
...
func _User_GetVolumeByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumeDetailReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).GetVolumeByUserId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.user/GetVolumeByUserId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetVolumeByUserId(ctx, req.(*VolumeDetailReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVolumeByUserId",
			Handler:    _User_GetVolumeByUserId_Handler,
		},
		{
